    ...
    <div>
      ...
      <div className="modal">
        <div className="modal-box relative">
          ...
          <h2 className="text-3xl font-bold text-center text-info">
            Booked Product
          </h2>
          <form onSubmit={handleSubmit(handleBookedProduct)}>
            ...
            <div className="form-control w-full max-w-x">
              ...
              <input
                ...
                {...register("phone", {
                  ...
                  minLength: {
                    value: 11,
                    message: "Please valid a phone number",
                  },
                })}
                className="input input-sm input-bordered  w-full"
            ...
            <div className="form-control w-full max-w-x">
              ...
              {errors.meetingLocation && (
                <p className="text-red-600">{errors.meetingLocation.message}</p>
              )}
            </div>

            <input
              className="mt-3 btn btn-accent text-white w-full"
              type="submit"
              value="Submit"
            />
          </form>
